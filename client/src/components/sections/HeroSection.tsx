...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="bg-[#0d1e21]">
      <div className="flex relative lg:py-20  2xl:container 2xl:mx-auto flex-col lg:px-20  text-white lg:pt-20 py-8 px-4 gap-10 lg:gap-10 z-20 overflow-hidden">
        <div className="max-sm:hidden absolute top-10 right-0  xl:right-28  z-0 -translate-y-44">
          <IoLayersOutline className="text-[400px] icon lg:text-[600px] text-[#f4f4f4]/10" />
        </div>
        <div className="flex flex-col 2xl:container 2xl:mx-auto gap-4 lg:flex-row lg:justify-between lg:items-end">
          ...
          <div className="flex flex-col gap-6 lg:items-center hero  h-full  lg:w-1/2">
        ...
        <p className="bg-clip-text hero lg:text-center bg-gradient-to-r from-white from-50% to-white/30  text-transparent text-3xl lg:text-6xl  font-bold tracking-tight">
