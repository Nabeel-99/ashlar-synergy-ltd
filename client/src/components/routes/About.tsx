...
const About = () => {
  ...
  return (
    <div className="flex flex-col relative  h-full">
      ...
      <section className="flex flex-col items-center 2xl:container 2xl:mx-auto px-4 lg:px-20 gap-10 pb-20">
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          <div className="flex gap-4 h-full lg:w-1/2">
            <div>
              <img
                src="/building.jpg"
                alt="building"
      ...
      <section className=" bg-[#f4f4f4] ">
        <div className="lg:px-20 gap-6 py-20 flex flex-col w-full 2xl:container 2xl:mx-auto px-4">
          ...
          <p className="text-3xl text-center lg:text-4xl tracking-tighter font-bold">
            Solutions That Deliver Results.
          </p>
          <div className="lg:mt-20">
            {chooseDetails.map((item, index) => (
              <div className="border-t py-4 w-full" key={index}>
                <div className="flex flex-col gap-2 md:flex-row md:justify-between w-full">
                  ...
                  <div>
                    <img
                      src={item.image}
                      alt={item.title}
                      className="object-cover w-full aspect-video md:w-96 lg:h-36 rounded-xl"
                    />
                  </div>
                </div>
              </div>
